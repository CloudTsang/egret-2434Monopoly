window.skins=window.skins||{};
		...
		this.states = [
			...
			new eui.State ("p3",
				[
					...
					new eui.SetProperty("_Image6","source","vmenu_jpg"),
					new eui.SetProperty("_Label15","text","不同类型的直播\n对neta的需求不同"),
					new eui.SetProperty("_Image7","source","nselect_jpg"),
	...
	function titlePage() {
		_super.call(this);
		this.skinParts = ["img1","img2","btnStart","btnDes","btnStart2","btnLoad"];
		
		this.height = 720;
		this.width = 1280;
		this.elementsContent = [this._Rect1_i(),this.img1_i(),this.img2_i(),this._Group1_i(),this.btnStart_i(),this.btnDes_i(),this.btnStart2_i(),this.btnLoad_i()];
	}
