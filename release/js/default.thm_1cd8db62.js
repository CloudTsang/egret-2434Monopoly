window.skins=window.skins||{};
	...
	function descriptPanel() {
		...
		this.states = [
			new eui.State ("p1",
				[
					new eui.AddItems("_Label3","contents",2,"_Group9"),
					new eui.AddItems("_Image1","_Group9",0,""),
					new eui.AddItems("_Group1","_Group9",2,"_Group4"),
					new eui.AddItems("_Image3","_Group9",2,"_Group4")
				])
			,
			new eui.State ("p2",
				[
					new eui.AddItems("_Label2","contents",2,"_Group9"),
					new eui.AddItems("_Image6","_Group7",0,""),
					new eui.AddItems("_Group7","_Group9",1,""),
					...
					new eui.SetProperty("_Image6","source","desp_json#rmenu")
				])
			,
			new eui.State ("p3",
				[
					...
					new eui.SetProperty("_Image6","source","desp_json#vmenu"),
					new eui.SetProperty("_Label15","text","不同类型的直播\n对neta的需求不同"),
					new eui.SetProperty("_Image7","width",200),
					new eui.SetProperty("_Image7","height",240),
					new eui.SetProperty("_Image7","source","desp_json#nselect"),
					new eui.SetProperty("_Label16","text","部分neta有数量消耗\n或使用冷却的设定")
				])
			,
			new eui.State ("p4",
				[
					new eui.AddItems("_Label1","contents",2,"_Group9"),
					new eui.AddItems("_Image5","_Group5",0,""),
					new eui.AddItems("_Group5","_Group9",1,""),
					new eui.AddItems("_Group6","_Group9",1,"")
				])
			,
			new eui.State ("p5",
				[
					new eui.AddItems("_Label5","_Group9",2,"_Group4"),
					new eui.AddItems("_Group2","_Group9",2,"_Group4"),
					new eui.AddItems("_Label6","_Group9",2,"_Group4"),
					new eui.AddItems("_Group3","_Group9",2,"_Group4"),
					new eui.AddItems("_Label7","_Group9",2,"_Group4"),
					new eui.AddItems("_Image4","_Group9",1,""),
					new eui.SetProperty("_Group9","layout",this._VerticalLayout3)
				])
		];
	}
	...
	_proto.contents_i = function () {
		...
		t.verticalCenter = 0;
		t.layout = this._VerticalLayout1_i();
		t.elementsContent = [this._Group9_i(),this._Label17_i()];
		return t;
	};
	_proto._VerticalLayout1_i = function () {
		var t = new eui.VerticalLayout();
	...
	_proto._Label6_i = function () {
		...
		this._Label6 = t;
		t.size = 24;
		t.text = "可以专注培养一名Liver，在随机生成的日程上前进的单人模式。\n此模式下粉丝增长量将与前进格数有关。";
		t.x = 198;
		t.y = 82;
		return t;
	};
	...
	_proto._Label7_i = function () {
		...
		this._Label7 = t;
		t.size = 24;
		t.text = "决定前进格数时，除了普通的随机之外，还会从已有的Neta中\n随机抽取3个，玩家可选择1个根据其数值直接决定前进格数。";
		t.x = 295;
		t.y = 128;
		return t;
	};
	...
	_proto._Group7_i = function () {
		...
		t.elementsContent = [this._Label15_i()];
		return t;
	};
	...
	_proto._Group6_i = function () {
		...
		t.percentWidth = 100;
		t.layout = this._VerticalLayout2_i();
		t.elementsContent = [this._Group1_i(),this.cpn2Hide0_i(),this._Group4_i(),this.cpn2Hide1_i(),this.btnStart_i(),this._Group5_i(),this._Label3_i()];
		return t;
	};
	_proto._VerticalLayout2_i = function () {
		var t = new eui.VerticalLayout();
	...
	function maincharacter() {
		_super.call(this);
		this.skinParts = ["img","txtName","txtSubs","txtIncrease","txtStream","txtPrevStream","txtMoney","buffContainer","txts1","txts2","txts3","txts4","txteq","txtluck","txtSense","txtCommu","txtStrength","txtTalk","txtGame","txtSing","txtTech","btnClose","txtTips","containerTips"];
		
		this.height = 650;
		this.width = 750;
		this.elementsContent = [this._Group44_i(),this.containerTips_i()];
	}
	...
	_proto._Group44_i = function () {
		...
		t.x = 0;
		t.y = 0;
		t.elementsContent = [this._Rect1_i(),this._Group43_i(),this.btnClose_i()];
		return t;
	};
	_proto._Rect1_i = function () {
		var t = new eui.Rect();
	...
	_proto._Group43_i = function () {
		...
		t.y = 0;
		t.layout = this._HorizontalLayout3_i();
		t.elementsContent = [this._Group8_i(),this._Group42_i()];
		return t;
	};
	_proto._HorizontalLayout3_i = function () {
		var t = new eui.HorizontalLayout();
	...
	_proto._Group42_i = function () {
		...
		t.y = 348;
		t.layout = this._VerticalLayout6_i();
		t.elementsContent = [this.buffContainer_i(),this._Group21_i(),this._Group41_i()];
		return t;
	};
	_proto._VerticalLayout6_i = function () {
		var t = new eui.VerticalLayout();
	...
	_proto._Group21_i = function () {
		...
		t.percentWidth = 100;
		t.layout = this._VerticalLayout2_i();
		t.elementsContent = [this._Group10_i(),this._Group12_i(),this._Group14_i(),this._Group16_i(),this._Group17_i(),this._Group19_i(),this._Group20_i()];
		return t;
	};
	_proto._VerticalLayout2_i = function () {
		var t = new eui.VerticalLayout();
	...
	_proto._Group19_i = function () {
		...
		t.height = 44;
		t.percentWidth = 95;
		t.elementsContent = [this._Rect6_i(),this.txteq_i(),this._Group18_i()];
		return t;
	};
	...
	_proto._Group41_i = function () {
		...
		t.elementsContent = [this._Group40_i()];
		return t;
	};
	_proto._VerticalLayout3_i = function () {
		var t = new eui.VerticalLayout();
	...
	_proto._Group40_i = function () {
		...
		t.percentWidth = 100;
		t.layout = this._HorizontalLayout2_i();
		t.elementsContent = [this._Group30_i(),this._Group39_i()];
		return t;
	};
	_proto._HorizontalLayout2_i = function () {
		var t = new eui.HorizontalLayout();
	...
	_proto._Group30_i = function () {
		...
		t.percentWidth = 50;
		t.layout = this._VerticalLayout4_i();
		t.elementsContent = [this._Group23_i(),this._Group25_i(),this._Group27_i(),this._Group29_i()];
		return t;
	};
	_proto._VerticalLayout4_i = function () {
		var t = new eui.VerticalLayout();
	...
	_proto._Group23_i = function () {
		...
		t.percentHeight = 25;
		t.percentWidth = 100;
		t.elementsContent = [this._Label6_i(),this._Label7_i(),this.txtluck_i(),this._Group22_i()];
		return t;
	};
	_proto._Label6_i = function () {
		var t = new eui.Label();
	...
	_proto._Group25_i = function () {
		...
		t.percentHeight = 25;
		t.percentWidth = 100;
		t.elementsContent = [this._Label8_i(),this._Label9_i(),this.txtSense_i(),this._Group24_i()];
		return t;
	};
	_proto._Label8_i = function () {
		var t = new eui.Label();
	...
	_proto._Group27_i = function () {
		...
		t.percentHeight = 25;
		t.percentWidth = 100;
		t.elementsContent = [this._Label10_i(),this._Label11_i(),this.txtCommu_i(),this._Group26_i()];
		return t;
	};
	_proto._Label10_i = function () {
		var t = new eui.Label();
	...
	_proto._Group29_i = function () {
		...
		t.percentHeight = 25;
		t.percentWidth = 100;
		t.elementsContent = [this._Label12_i(),this._Label13_i(),this.txtStrength_i(),this._Group28_i()];
		return t;
	};
	_proto._Label12_i = function () {
		var t = new eui.Label();
	...
	_proto._Group39_i = function () {
		...
		t.percentWidth = 50;
		t.layout = this._VerticalLayout5_i();
		t.elementsContent = [this._Group32_i(),this._Group34_i(),this._Group36_i(),this._Group38_i()];
		return t;
	};
	_proto._VerticalLayout5_i = function () {
		var t = new eui.VerticalLayout();
	...
	_proto._Group32_i = function () {
		...
		t.percentHeight = 25;
		t.percentWidth = 100;
		t.elementsContent = [this._Label14_i(),this._Label15_i(),this.txtTalk_i(),this._Group31_i()];
		return t;
	};
	_proto._Label14_i = function () {
		var t = new eui.Label();
	...
	_proto._Group34_i = function () {
		...
		t.percentHeight = 25;
		t.percentWidth = 100;
		t.elementsContent = [this._Label16_i(),this._Label17_i(),this.txtGame_i(),this._Group33_i()];
		return t;
	};
	_proto._Label16_i = function () {
		var t = new eui.Label();
	...
	_proto._Group36_i = function () {
		...
		t.percentHeight = 25;
		t.percentWidth = 100;
		t.elementsContent = [this._Label18_i(),this._Label19_i(),this.txtSing_i(),this._Group35_i()];
		return t;
	};
	...
	_proto._Group38_i = function () {
		...
		t.percentHeight = 25;
		t.percentWidth = 100;
		t.elementsContent = [this._Label20_i(),this._Label21_i(),this.txtTech_i(),this._Group37_i()];
		return t;
	};
	...
	_proto.containerTips_i = function () {
		...
		t.x = 775;
		t.y = 93;
		t.elementsContent = [this._Rect7_i(),this.txtTips_i()];
		return t;
	};
	...
	function rollbtn() {
		_super.call(this);
		this.skinParts = ["txtRollNum","btn","result","rollNetaImg0","rollNetaTxt0","rollNetaName0","rollNeta0","rollNetaImg1","rollNetaTxt1","rollNetaName1","rollNeta1","rollNetaImg2","rollNetaTxt2","rollNetaName2","rollNeta2","singleRollNetaPanel"];
		
		this.height = 80;
		this.width = 80;
		this.elementsContent = [this._Group1_i(),this.result_i(),this.singleRollNetaPanel_i()];
	}
	...
	_proto.singleRollNetaPanel_i = function () {
		var t = new eui.Group();
		this.singleRollNetaPanel = t;
		t.anchorOffsetX = 260;
		t.height = 250;
		t.visible = false;
		t.width = 600;
		t.x = 0;
		t.y = -220;
		t.elementsContent = [this._Rect1_i(),this._Group5_i()];
		return t;
	};
	_proto._Rect1_i = function () {
		var t = new eui.Rect();
	...
	_proto._Group5_i = function () {
		...
		t.elementsContent = [this.rollNeta0_i(),this.rollNeta1_i(),this.rollNeta2_i()];
		return t;
	};
	...
	_proto.rollNeta0_i = function () {
		...
		t.touchChildren = false;
		t.touchEnabled = true;
		t.elementsContent = [this.rollNetaImg0_i(),this._Group2_i(),this.rollNetaName0_i()];
		return t;
	};
	_proto.rollNetaImg0_i = function () {
		var t = new eui.Image();
		this.rollNetaImg0 = t;
		t.height = 120;
		t.horizontalCenter = 0;
	...
	_proto._Group2_i = function () {
		...
		t.percentWidth = 100;
		t.layout = this._HorizontalLayout1_i();
		t.elementsContent = [this._Image1_i(),this.rollNetaTxt0_i()];
		return t;
	};
	_proto._HorizontalLayout1_i = function () {
		var t = new eui.HorizontalLayout();
	...
	_proto.rollNetaTxt0_i = function () {
		var t = new eui.Label();
		this.rollNetaTxt0 = t;
		t.percentWidth = 20;
		t.size = 36;
	...
	_proto.rollNetaName0_i = function () {
		var t = new eui.Label();
		this.rollNetaName0 = t;
		t.bottom = 70;
		t.percentWidth = 100;
		t.size = 20;
		t.text = "";
	...
	_proto.rollNeta1_i = function () {
		...
		t.touchChildren = false;
		t.touchEnabled = true;
		t.elementsContent = [this.rollNetaImg1_i(),this._Group3_i(),this.rollNetaName1_i()];
		return t;
	};
	_proto.rollNetaImg1_i = function () {
		var t = new eui.Image();
		this.rollNetaImg1 = t;
		t.height = 120;
		t.horizontalCenter = 0;
	...
	_proto._Group3_i = function () {
		...
		t.percentWidth = 100;
		t.layout = this._HorizontalLayout2_i();
		t.elementsContent = [this._Image2_i(),this.rollNetaTxt1_i()];
		return t;
	};
	_proto._HorizontalLayout2_i = function () {
		var t = new eui.HorizontalLayout();
	...
	_proto.rollNetaTxt1_i = function () {
		var t = new eui.Label();
		this.rollNetaTxt1 = t;
		t.percentWidth = 20;
		t.size = 36;
	...
	_proto.rollNetaName1_i = function () {
		var t = new eui.Label();
		this.rollNetaName1 = t;
		t.bottom = 70;
		t.percentWidth = 100;
		t.size = 20;
		t.text = "";
	...
	_proto.rollNeta2_i = function () {
		...
		t.touchChildren = false;
		t.touchEnabled = true;
		t.elementsContent = [this.rollNetaImg2_i(),this._Group4_i(),this.rollNetaName2_i()];
		return t;
	};
	_proto.rollNetaImg2_i = function () {
		var t = new eui.Image();
		this.rollNetaImg2 = t;
		t.height = 120;
		t.horizontalCenter = 0;
	...
	_proto._Group4_i = function () {
		...
		t.percentWidth = 100;
		t.layout = this._HorizontalLayout3_i();
		t.elementsContent = [this._Image3_i(),this.rollNetaTxt2_i()];
		return t;
	};
	_proto._HorizontalLayout3_i = function () {
		var t = new eui.HorizontalLayout();
	...
	_proto.rollNetaTxt2_i = function () {
		var t = new eui.Label();
		this.rollNetaTxt2 = t;
		t.percentWidth = 20;
		t.size = 36;
	...
	_proto.rollNetaName2_i = function () {
		var t = new eui.Label();
		this.rollNetaName2 = t;
		t.bottom = 70;
		t.percentWidth = 100;
		t.size = 20;
		t.text = "";
	...
	function scorePanel() {
		_super.call(this);
		this.skinParts = ["img0","txtStream0","txtSub0","img1","txtStream1","txtSub1","img2","txtStream2","txtSub2","img3","txtStream3","txtSub3","groupMulti","btnTitle"];
		
		this.height = 720;
		this.width = 1280;
		this.elementsContent = [this._Rect1_i(),this._Group18_i()];
	}
	...
	_proto._Group18_i = function () {
		...
		t.percentWidth = 100;
		t.layout = this._VerticalLayout5_i();
		t.elementsContent = [this._Group4_i(),this.groupMulti_i(),this._Group17_i()];
		return t;
	};
	_proto._VerticalLayout5_i = function () {
		var t = new eui.VerticalLayout();
	...
	function titlePage() {
		_super.call(this);
		this.skinParts = ["img1","img2","btnStart","btnDes","btnLoad","btnRank","btnStart2"];
		
		this.height = 720;
		this.width = 1280;
		this.elementsContent = [this._Rect1_i(),this.img1_i(),this.img2_i(),this._Group1_i(),this.btnStart_i(),this.btnDes_i(),this.btnLoad_i(),this.btnRank_i(),this.btnStart2_i()];
	}
	...
	_proto.img1_i = function () {
		...
		t.source = "desp_json#title_nazono";
		t.top = 20;
		t.width = 400;
		return t;
	};
